...
import { budgets, distanceBands, moods, spots, type Spot } from '../data/spots';
...
export function SortiesPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <PageSeo
        title="Catalogue sorties trottinette autour d'Aix-en-Provence"
        description="Parcourez les sorties en trottinette autour d'Aix-en-Provence par distance, ambiance, budget et recharge a verifier."
        path="/sorties"
        jsonLd={buildCollectionSeoGraph({
          path: '/sorties',
          title: "Catalogue sorties trottinette autour d'Aix-en-Provence",
          description:
            "Parcourez les sorties en trottinette autour d'Aix-en-Provence par distance, ambiance, budget et recharge a verifier.",
