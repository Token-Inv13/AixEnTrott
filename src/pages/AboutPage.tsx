      ...
      <section className="mt-6 grid gap-4 lg:grid-cols-[1fr_0.9fr]">
        <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft">
          ...
          <p className="mt-4 text-sm leading-6 text-slate-600">
            Aix en trott aide à comparer des sorties en trottinette électrique autour d’Aix-en-Provence avec une lecture
            simple des distances, de l’autonomie, de la recharge et du niveau de préparation.
          </p>
          <p className="mt-4 text-sm leading-6 text-slate-600">
          ...
          <p className="mt-4 text-sm leading-6 text-slate-600">
            Tu restes responsable de ton trajet, de ton équipement et de ta sécurité. Le site sert d’aide à la décision,
            pas de garantie.
          </p>
          <div className="mt-6">
        ...
        <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft">
          ...
          <div className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm leading-6 text-amber-900">
            Si un point de sortie ou de recharge te semble faux, utilise le bouton de signalement dans la fiche ou la page recharge.
          </div>
        </div>
      </section>
    </div>
